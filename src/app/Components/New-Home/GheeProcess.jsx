...
export default function GheeProcess() {
  ...
  return (
    <section id="ghee-process" ref={bgRef} className="relative overflow-hidden bg-[#0c0a09] py-28 sm:py-36">
      {/* ---------- Farmer-in-field background at 40% visibility ---------- */}
      <motion.div style={{ y: bgY }} className="pointer-events-none absolute inset-0 z-0">
        <img
          ...
          alt="Farmer working in field with cows"
          className="h-full w-full object-cover opacity-40"
        />
        <div className="absolute inset-0 bg-gradient-to-b from-[#0c0a09]/80 via-[#0c0a09]/70 to-[#0c0a09]/85" />
            ...
            {steps.map((s, i) => {
              ...
              return (
                <div key={s.n} className={`relative flex items-center ${left ? 'sm:justify-start' : 'sm:justify-end'}`}>
                  ...
                  >
                    <div className="group relative overflow-hidden rounded-2xl border border-white/10 bg-white/[0.03] p-6 backdrop-blur-sm transition-all hover:border-amber-400/30 hover:bg-white/[0.06]">
